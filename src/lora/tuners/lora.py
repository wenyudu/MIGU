            ...
            if target_module_found:
                ...
                if isinstance(target, LoraLayer):
                    ...
                    if loaded_in_8bit and isinstance(target, bnb.nn.Linear8bitLt):
                        ...
                        new_module = Linear(adapter_name, in_features, out_features, bias=bias, **kwargs) # modified
...
class LoraLayer:
    ...
    def update_layer(self, adapter_name, r, lora_alpha, lora_dropout, init_lora_weights): # modified 
...
class Linear(nn.Linear, LoraLayer):
    ...
    def forward(self, x: torch.Tensor):
        ...
        if self.r[self.active_adapter] > 0 and not self.disable_adapters:
